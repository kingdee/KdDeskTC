        ...
        Data::Config((name, value)) => match value {
            None => {
                ...
                if name == "id" {
                    ...
                    value = Some(Config::get_cstdir());
                } else if name == "pwdupd" {
                    value = Some(Config::get_pwdupd());
                } else if name == "idle" {
                    value = Some(Config::get_idle());
                } else if name == "flagex" {
                    value = Some(Config::get_flagex());
                } else if name == "uid" {
                    value = Some(Config::get_uid());
                } else {
                    value = None;
                }
            ...
            Some(value) => {
                if name == "id" {
                    ...
                    Config::set_cstdir(&value);
                } else if name == "pwdupd" {
                    Config::set_pwdupd(&value);
                } else if name == "idle" {
                    Config::set_idle(&value);
                } else if name == "flagex" {
                    Config::set_flagex(&value);
                } else if name == "uid" {
                    Config::set_uid(&value);
                } else {
                    return;
                }
...
#[tokio::main(flavor = "current_thread")]
async fn set_config_ex(name: &str, value: String) -> ResultType<()> {
    let mut c = connect(6000, "").await?;
    c.send_config(name, value).await?;
    Ok(())
}
pub fn set_password(v: String) -> ResultType<()> {
    println!("set_password -> {}", v);
    Config::set_password(&v);
    set_config("password", v)
}
// added by fantacy.
pub fn set_cstdir(v: String) -> ResultType<()> {
    Config::set_cstdir(&v);
    set_config("cstdir", v)
}
pub fn set_pwdupd(v: String) -> ResultType<()> {
    Config::set_pwdupd(&v);
    set_config("pwdupd", v)
}
pub fn set_idle(v: String) -> ResultType<()> {
    Config::set_idle(&v);
    set_config("idle", v)
}
pub fn set_flagex(v: String) -> ResultType<()> {
    Config::set_flagex(&v);
    set_config("flagex", v)
}
pub fn set_uid(v: String) -> ResultType<()> {
    Config::set_uid(&v);
    set_config("uid", v)
}
pub fn set_password_ex(v: String) -> ResultType<()> {
    set_config_ex("password", v)
}
...
pub fn get_cstdir() -> String {
    if let Ok(Some(v)) = get_config("cstdir") {
        Config::set_cstdir(&v);
        v
    } else {
        Config::get_cstdir()
...
pub fn get_pwdupd() -> String {
    if let Ok(Some(v)) = get_config("pwdupd") {
        Config::set_pwdupd(&v);
        v
    } else {
        Config::get_pwdupd()
...
pub fn get_idle() -> String {
    if let Ok(Some(v)) = get_config("idle") {
        Config::set_idle(&v);
        v
    } else {
        Config::get_idle()
...
pub fn get_flagex() -> String {
    if let Ok(Some(v)) = get_config("flagex") {
        Config::set_flagex(&v);
        v
    } else {
        Config::get_flagex()
...
pub fn get_uid() -> String {
    if let Ok(Some(v)) = get_config("uid") {
        Config::set_uid(&v);
        v
    } else {
        Config::get_uid()
