...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "允许控制本机"),
        ("desk_tip", "你的桌面可以通过下面的识别码和验证码访问。"),
        ("ID", "本机识别码"),
        ("Verification Code", "本机验证码"),
        ("Password", "密码"),
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入KdDeskTC网络..."),
        ("Enable Service", "允许服务"),
        ("Start Service", "启动服务"),
        ...
        ("TCP Tunneling", "TCP隧道"),
        ("Remove", "删除"),
        ("Refresh random password", "刷新随机验证码"),
        ("Set your own password", "设置验证码"),
        ...
        ("Retry", "再试"),
        ("OK", "确认"),
        ("Password Required", "需要验证码"),
        ("Please enter your password", "请输入验证码"),
        ("Remember password", "记住验证码"),
        ("Wrong Password", "验证码错误"),
        ("Do you want to enter again?", "还想输入一次吗?"),
        ("Connection Error", "连接错误"),
        ("Error", "错误"),
        ("Reset by the peer", "连接被关闭(对方可能未登录)"),
        ("Connecting...", "正在连接..."),
        ...
        ("Set Password", "设置验证码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于UAC限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将KdDeskTC安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("New version V", "发现新版本V"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予KdDeskTC\"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予KdDeskTC\"屏幕录制\" 权限。"),
        ("Installing ...", "安装 ..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("Relayed and encrypted connection", "加密中转连接"),
        ("Direct and unencrypted connection", "非加密直连"),
        ("Relayed and unencrypted connection", "非加密中转连接"),
        ("Enter Remote ID", "输入对方ID"),
        ("Enter your password", "输入验证码"),
        ("Logging in...", "正在登录..."),
        ...
        ("Password missed", "验证码没有填写"),
        ("Wrong credentials", "用户名或者验证码错误"),
        ("Edit Tag", "修改标签"),
        ...
        ("android_input_permission_tip1", "為了讓遠程設備通過鼠標或者觸屏控制您的安卓設備，你需要允許KdDeskTC使用\"無障礙\"服務。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [KdDeskTC Input] 服务开启。"),
        ...
        ("Help", "帮助"),
        ("The size of file is over 50M","文件超过50M,不允许传输!"),
        ("Failed","失败"),
    ].iter().cloned().collect();
}
