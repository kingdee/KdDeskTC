...
!define PRODUCT_NAME "KdDeskTC"
!define PRODUCT_DESCRIPTION "Installer for ${PRODUCT_NAME}"
!define COPYRIGHT "Copyright © Kingdee 2022"
...
Name "${PRODUCT_NAME}"
Outfile "KdDeskTC-${VERSION}-setup.exe"
#Caption "Setup - ${PRODUCT_NAME}"
Caption "Setup - 金蝶云.远程办公助手-远程协助"
...
!define MUI_ICON "src\icon48.ico"
...
Section "Install"
  ...
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "Publisher" "Kingdee"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "HelpLink" "https://www.kingdee.com/"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "URLInfoAbout" "https://www.kingdee.com/"
  WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}" "URLUpdateInfo" "https://www.kingdee.com/"
  ...
  File "target\release\vcruntime140.dll"
